...
<html>
    <head>
		...
		<script>
			...
			function getRowVal(indexRow){
				var numIndex = indexRow.rowIndex;
				var rowValue = document.getElementById('dspTblCustomer').rows[numIndex].cells;
				txtCancelID.value = rowValue[0].innerHTML;
				txtCancelFullName.value = (rowValue[2].innerHTML + " " + rowValue[1].innerHTML);
				txtCancelIn.value = rowValue[3].innerHTML;
				txtCancelOut.value = rowValue[4].innerHTML;
				txtCancelContact.value = rowValue[5].innerHTML;
				txtCancelEmail.value = rowValue[6].innerHTML;
				txtCancelRmType.value = rowValue[7].innerHTML;
			}
			
			$(function(){
				$('#dspTblCustomer .hoverTable').click(function(){
    ...
    <body>
		...
		<div class = "container">
			...
			<ul class = "nav nav-tabs">
				<li class = "pull-right"><a href = "#">Cancelled Reservations</a></li>
				<li class = "pull-right active"><a href = "bookedCustomers.php">Booked Customers</a></li>
			</ul>
			</br>
			
			<div class = "col-sm-12 pull-right">
				<form class = "form-horizontal" method = "POST">
					<div class = "form-group col-sm-5 pull-right has-feedback">
						<div class = "col-sm-12">
				...
				<div class = "col-sm-12">
					<div style = "overflow-y: scroll; height: 230px;">
						<table id = "dspTblCustomer" class = "table table-condensed col-sm-12">
							<tr>
								<th>Customer ID</th>
								<th>Lastname</th>
								<th>Firstname</th>
							...
							$query = "SELECT * FROM tblCustomers ORDER BY CheckInDate;";
							$run = mysqli_query($con, $query);
							
							while($data = mysqli_fetch_assoc($run)){?>
								<tr class = "hoverTable" onClick = "getRowVal(this)"><?php
									$InWordFormat = strtotime($data['CheckInDate']);
									$OutWordFormat = strtotime($data['CheckOutDate']);?>
									<td><?php echo $data['CustomerID']?></td>
									<td><?php echo $data['Lastname']?></td>
									<td><?php echo $data['Firstname']?></td>
									<td><?php echo date("M j, Y", $InWordFormat)?></td>
									<td><?php echo date("M j, Y", $OutWordFormat)?></td>
									<td class = "hidden"><?php echo $data['ContactNo']?></td>
									<td class = "hidden"><?php echo $data['EmailAdd']?></td>
									<td class = "hidden"><?php echo $data['RoomType']?></td><?php
									if($data['Status'] == 'Pending 50%'){?>
										<td><span class = "label label-danger"><?php echo $data['Status']?></span></td>
										<td>
											<form method = "POST" action = "customerDetails.php">
												<input type = "hidden" name = "txtHiddenCustID" value = "<?php echo $data['CustomerID'];?>">
												<button class = "btn-link" name = "btnShowDetails" title = "Show Details"><span class = "glyphicon glyphicon-edit"></span></button>
												<a class = "btn-link" href = "#CancelReservation" data-toggle = "modal" name = "linkCancel" title = "Cancel reservation"><span class = "glyphicon glyphicon-trash"></span></a>
											</form>
										</td><?php
									}
										...
										<td>
											<form method = "POST" action = "customerDetails.php">
												<input type = "hidden" name = "txtHiddenCustID" value = "<?php echo $data['CustomerID'];?>">
												<button class = "btn-link" name = "btnShowDetails" title = "Show Details"><span class = "glyphicon glyphicon-edit"></span></button>
												<a class = "btn-link" href = "#" data-toggle = "modal" name = "linkCancel" title = "Disabled"><span class = "glyphicon glyphicon-ban-circle"></span></a>
											</form>
										</td><?php
									}
									?>
			...
			<div class = "modal-dialog">
				<div class = "modal-content" style = "width: 80%; margin: 0 auto;">
					<div class = "modal-header">
						<b><span class = "glyphicon glyphicon-user"></span> Cancellation Details</b>
					...
					<form class = "form-horizontal" method = "POST">
						<div class = "modal-body"></br>
							<div class = "form-group">
								...
								<div class = "col-sm-6">
									<input type = "text" class = "form-control" name = "txtCancelID" id = "txtCancelID">
								</div>
							</div>
							...
							<div class = "form-group">
								...
								<div class = "col-sm-6">
									<input type = "text" class = "form-control" name = "txtCancelFullName" id = "txtCancelFullName">
								</div>
							</div>
							...
							<div class = "form-group">
								...
								<div class = "col-sm-6">
									<input type = "text" class = "form-control" name = "txtCancelContact" id = "txtCancelContact">
								</div>
							</div>
							...
							<div class = "form-group">
								...
								<div class = "col-sm-6">
									<input type = "text" class = "form-control" name = "txtCancelEmail" id = "txtCancelEmail">
								</div>
							</div>
							...
							<div class = "form-group">
								...
								<div class = "col-sm-6">
									<input type = "text" class = "form-control" name = "txtCancelRmType" id = "txtCancelRmType">
								</div>
							</div>
							...
							<div class = "form-group">
								...
								<div class = "col-sm-6">
									<input type = "text" class = "form-control" name = "txtCancelIn" id = "txtCancelIn">
								</div>
							</div>
							...
							<div class = "form-group">
								...
								<div class = "col-sm-6">
									<input type = "text" class = "form-control" name = "txtCancelOut" id = "txtCancelOut">
								</div>
							</div>
						</div>
						
						<div class = "modal-footer">
							<button class = "btn btn-danger" name = "btnCancel"><span class = "glyphicon glyphicon-remove"></span> Cancel Reservation</button>
						</div>
					</form>
				</div>
			</div>
