			...
			if(isset($_POST['btnUpdateProfile'])){
				...
				if($result){?>
					<script type = "text/javascript">
						...
						window.location.href = "menusCoffee.php";
					</script><?php
				}
		...
		<div class = "container">
			...
			<!--Menus Coffee-->
				...
				<div class = "col-sm-9 panel panel-default">
					<div class = "panel-body" style = "height: 300px;"></br>
							...
							<table class = "table table-condensed">
								...
								<?php
									if(!empty($_POST['txtSearch'])){
										...
										$querySel = "SELECT DISTINCT MenuID, CoffeeName, Status FROM tblMenus WHERE CoffeeName LIKE '$searchResult%' ORDER BY CoffeeName ASC;";
										$run = mysqli_query($con, $querySel);
										
										while($tblMenus = mysqli_fetch_assoc($run)){
											$MenuID = $tblMenus['MenuID'];
											$MenuName = $tblMenus['CoffeeName'];
											$Status = $tblMenus['Status'];?>
											<tr>
												<td><?php echo $MenuID;?></td>
												<td><?php echo $MenuName;?></td><?php
												$querySelSize = "SELECT Size FROM tblMenus WHERE MenuID = '$MenuID' AND CoffeeName = '$MenuName';";
									...
									<div class = "col-sm-6 pull-right" style = "text-align: right;">
										...
										$querySel = "SELECT DISTINCT MenuID, CoffeeName, Status FROM tblMenus ORDER BY CoffeeName ASC;";
